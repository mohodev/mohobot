...
export interface ProviderProfile {baseUrl:string;apiKey?:string;model:string;maxTokens?:number;temperature?:number;timeoutMs?:number;retries?:number;budget?:Partial<ModelBudget>;circuit?:{failureThreshold?:number;openMs?:number};}
