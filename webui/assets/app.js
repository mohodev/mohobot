...
const tabs = { overview,bots,plugins,operations,logs,memory,behavior,debugchat,knowledge, users, health, models,providers, config, characters, world,device, metrics };
